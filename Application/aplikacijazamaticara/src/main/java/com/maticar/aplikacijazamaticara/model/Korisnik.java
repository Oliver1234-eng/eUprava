...
public class Korisnik {
    ...
    public Korisnik(String jmbg, String ime, String prezime, Pol pol, String datumRodjenja, String mestoRodjenja, String imeRoditelja, String adresa, String korisnickoIme, String lozinka) {
        this.jmbg = jmbg;
        this.ime = ime;
    ...
    public Korisnik(String ime, String prezime, Pol pol, String datumRodjenja, String mestoRodjenja, String imeRoditelja, String adresa, String korisnickoIme, String lozinka) {
        this.ime = ime;
        this.prezime = prezime;
        this.pol = pol;
        this.datumRodjenja = datumRodjenja;
